...
*
* @author	Ognanesson Group a.k.a. Og (Pablo Echegoyen Ruiz, Ignacio Ruiz García, Guillermo Ruiz Laborda)
* @date		14/12/2018
*/
...
public class OgTester{
	//Input file with the parameters needed 
	private static InputData in;
	//Lattice
	...
	//length of the lattice
	private int length;
	//The probabilities arrayList is created in the constructor and used in the doIaccept method
	private ArrayList<Double[]> prob;
	//ArrayList with the positions of the N-families of neighbor
	private static ArrayList<ArrayList<int[]>> neighbors;
	...
	/**
	 * MAIN PROGRAM TO TEST THE PERFORMANCE OF THE CLASS METHODS
	 */
	public static void main(String [ ] args) {
		//We create a random Lattice 
		L= new int[40][40];
...
//		}
		...
		//We create the in object
		in=new InputData();
		// We create a Og object
		OgTester Arr=new OgTester(in, L);
	...
	public OgTester(InputData in,int[][] L) {
		//We initialize the parameters 
			...
			totalEnergy=0;
			//We set the initial magnetization considering all the spins are pointing down in the initial state
	...
	public static void checkFlip(int x , int y) {
